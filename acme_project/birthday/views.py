...
# собственный миксин для проверки авторства
...
class BirthdayCreateView(LoginRequiredMixin, CreateView):
    ...
    # перадаем объект пользователя в поле объекта формы, что бы знать какой
    # именно пользователь создал запись. Для этого переопределяем метод
    # валидации (по документации)
